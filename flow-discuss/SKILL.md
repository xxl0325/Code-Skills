...
- 持续反问，直到关键需求信息足够明确。
- 创建或更新 `plans/changes/<change-name>/SPEC.md`、`STATE.md`。
...
8. 每轮用户回答后，更新需求理解，并判断是否达到“SPEC 完成度门槛”。未达到时继续反问，不要进入设计。
9. 规格明确后，产出：
